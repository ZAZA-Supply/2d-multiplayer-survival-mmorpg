 ...
 */
export namespace SplitStackWithinFurnace {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: SplitStackWithinFurnace): void {
    SplitStackWithinFurnace.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): SplitStackWithinFurnace {
    return SplitStackWithinFurnace.getTypeScriptAlgebraicType().deserialize(reader);
  }
